...
import com.project.domain.usecase.LikePhotoUseCase
import com.project.domain.usecase.RequestAccessTokenUseCase
import com.project.domain.usecase.SearchPhotosUseCase
import com.project.domain.usecase.SetAccessTokenUseCase
...
class FeedViewModel @Inject constructor(
    ...
    private val _requestAccessTokenUiState = MutableStateFlow<RequestAccessTokenUiState>(
        RequestAccessTokenUiState.Loading
    )
    val requestAccessTokenUiState = _requestAccessTokenUiState.asStateFlow()

    private val _setAccessTokenUiState = MutableStateFlow<SetAccessTokenUiState>(
        SetAccessTokenUiState.Loading
    )
